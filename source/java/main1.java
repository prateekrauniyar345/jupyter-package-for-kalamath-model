...
public class main1 {
    public static void main(String[] args) throws Exception {
        ...
        // Load the MOJO model with configuration to handle unknown categorical levels
        EasyPredictModelWrapper.Config config = new EasyPredictModelWrapper.Config()
            .setConvertUnknownCategoricalLevelsToNa(true);  // Handle unknown categories
        EasyPredictModelWrapper model = new EasyPredictModelWrapper(config.setModel(MojoModel.load("GBM_model_python_1728350120177_1.zip")));
        ...
        try {
            ...
            for (int i = 1; i < lines.size(); i++) {
                ...
                try {
                    ...
                    System.out.println("Error predicting row " + i + ": " + e.getMessage());
                }
            }
